...
The delivered package is immediately usable for repository organization, onboarding, smoke-test verification, and preparing a real Seg2Change run once the original source tree, checkpoints, datasets, and GPU runtime are available.
